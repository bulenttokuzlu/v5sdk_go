...
func TestRESTAPIGet(t *testing.T) {
	...
	fmt.Println("\tTotal time consuming: ", response.TotalUsedTime)
	fmt.Println("\tRequest time consuming: ", response.ReqUsedTime)
	fmt.Println("\tReturn message: ", response.Body)
